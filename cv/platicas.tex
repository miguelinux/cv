...
\begin{loneinnerlist}
  ...
  \item Introducción a LXC/Incus \emph{LinuxCabal} \hfill{\emph{2025}}
  \item Como usar los Quadlets de Podman \emph{KCD} \hfill{\emph{2025}}
  \item Ve tu correo desde linea de comandos \emph{LinuxCabal} \hfill{\emph{2024}}
  \item Como contribuir al kernel de Linux, \emph{CCOSS} \hfill{\emph{2024}}
  \item Verificación en dos pasos o 2FA, \emph{FSL} \hfill{\emph{2024}}
  \item Haz tus presentaciones con \LaTeX{}, beamber y git, \emph{FSL} \hfill{\emph{2024}}
