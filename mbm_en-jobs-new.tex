...
\hypersetup{pdfauthor={Miguel Bernal Marin},
            pdftitle={Miguelinux CV},
	    }
...
\begin{center}
  \textbf{\Huge Miguel Bernal Marin} \\
  \small +52 00 0000 0000 $|$ \href{mailto:miguel.bernal.marin@gmail.com}
	{miguel.bernal.marin@gmail.com} $|$ 
  \href{https://linkedin.com/in/miguelinux}{linkedin.com/in/miguelinux} $|$
...
\section{Experience}
\textbf{INTEL} \hfill \textit{August 2011 to July 2025} \\
\textbf{OS Development Engineer}, \textit{August 2021 to Present}
\begin{itemize}
  \item \textbf{INTEL} \hfill \textit{August 2011 to July 2025}
    \begin{itemize}
      \item \textbf{OS Development Engineer}, \textit{August 2021 to Present}
    \end{itemize}
  \item dos
  \item tres
\end{itemize}
\textbf{Software Engineer}, \textit{August 2021 to Present}
\begin{itemize}
  \item Uno
  \item dos
  \item tres
